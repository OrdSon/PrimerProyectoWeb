...
<!DOCTYPE html>
<html>
    <jsp:include page="estiloRegistrarLaboratorista.css"/>
    <head>
        <title>Registrar Laboratorista</title>
        
        <link rel="stylesheet" href="estiloRegistrarLaboratorista.css">
    ...
    <body>
        <%  Laboratorista laboratorista = new Laboratorista();
            ...
            try {
                ...
                if (laboratorista.crearLaboratorista(datos, dataSource) == false) {
